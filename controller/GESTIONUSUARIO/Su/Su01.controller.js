         ...
         if (Usuario != "") {
          ...
          $.ajax({
            ...
            success:  function (response) {                           
              if (response=="") {
                sap.m.MessageToast.show("El usuario ingresado no existe");
              }else{
                thes.getRouter().navTo("su01V",{usuario:Usuario});
              }
            },
          ...
          sap.m.MessageToast.show("Ingrese el nombre de usuario que desea visualizar");
        }
        ...
        $.ajax({
          ...
          success:  function (response) {                           
            if (response=="") {
              ...
              thes.getRouter().navTo("su01M",{usuario:Usuario});                                
            }
          },
          error: function (xhr, ajaxOptions, thrownError) {
            alert(xhr.status);
  ...
  onDelete: function(oEvent){
    ...
    if (Usuario != "") {
      ...
      sap.m.MessageToast.show("Ingrese el nombre de usuario que desea eliminar");
    }
 ...
 onLock: function(oEvent){
  ...
  if (Usuario != "") {
    ...
    sap.m.MessageToast.show("Ingrese el nombre de usuario que desea bloquear");
  }   
},
...
onUnLock: function(oEvent){
  ...
  if (Usuario != "") {
    ...
    sap.m.MessageToast.show("Ingrese el nombre de usuario que desea desbloquear");
  }    
},
...
onEditPass: function(oEvent){
  ...
  if (Usuario != "") {
    ...
    sap.m.MessageToast.show("Ingrese el nombre de usuario para modificar contraseña");
  }       
} 
});      
});